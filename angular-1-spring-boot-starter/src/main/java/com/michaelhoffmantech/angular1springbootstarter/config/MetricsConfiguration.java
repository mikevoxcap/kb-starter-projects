   ...
   public static class GraphiteRegistry {
      ...
      private void init() {
         if (applicationProperties.getMetrics().getGraphite().isEnabled()) {
            ...
            String graphiteHost = applicationProperties.getMetrics().getGraphite()
                  .getHost();
            Integer graphitePort = applicationProperties.getMetrics().getGraphite()
                  .getPort();
            String graphitePrefix = applicationProperties.getMetrics().getGraphite()
                  .getPrefix();
            ...
            GraphiteReporter graphiteReporter = GraphiteReporter
                  ...
                  .convertDurationsTo(TimeUnit.MILLISECONDS).prefixedWith(graphitePrefix)
                  .build(graphite);
